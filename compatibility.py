...
#     else:
#         raise Exception('Property \'{}\' is not a column of the given GeoDataFrame.'.format(prop))
...
#      - 'population', the sum of unit populations
#     """
#     sum_min_pieces = 0
#     sum_intersections = 0
...
if __name__ == "__main__":
    ...
    print(map_1["population"])
    edge = random.choice(list(map_1["cut_edges"]))
    flipped_node, other_node = edge[0], edge[1]
    flip = {flipped_node: map_1.assignment[other_node]}
    new_map = map_1.flip(flip)
    print(new_map["population"])
    ...
    compat_manager_pop = CompatibilityManager(map_1, map_2, map_1_gdf, prop='population')
    print(compat_manager_pop.compat_index)

    compat_index_pop = compatibility(map_1, map_2, gdf, prop='population')
